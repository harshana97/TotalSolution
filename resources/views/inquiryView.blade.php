...
<a href="/addInqu" class = "btn btn-primary">Add new</a>
    ...
    <div class="tab">
        <button class="tablinks" onclick="openCity(event, 't1')" id="defaultOpen">Active</button>
        <button class="tablinks" onclick="openCity(event, 't2')">New</button>
        <button class="tablinks" onclick="openCity(event, 't3')">All</button>
        <button class="tablinks" onclick="openCity(event, 't4')">Expired</button>
    </div>
    ...
    <table class="table table-dark" data-name="mytable" id="myTable1">
     ...
     <th>Change Status</th>
        ...
        <tr>
            ...
            <td>
                @if($inqu1->status == "Active")
                    <a href="/activeMarkActive/{{$inqu1->inquiryid}}" class = "btn btn-success">Mark Expired</a>
                 @else
                    <a href="/activeMarkExpired/{{$inqu1->inquiryid}}" class = "btn btn-warning">Expired</a>
                @endif
            </td>

            
            <td><a href="/viewInquiry/{{$inqu1->inquiryid}}" class = "btn btn-primary">View</button></td>
            <td><a href="/updateInquiry/{{$inqu1->inquiryid}}" class = "btn btn-primary">Update</button></td>
            <td><a href="/deleteInquiry/{{$inqu1->inquiryid}}" class = "btn btn-primary" >Cancel</button></td>
        </tr>
    ...
    <table class="table table-dark" id="myTable2" data-name="mytable">
     ...
     <th>Change Status</th>
        ...
        <tr>
            ...
            <td>
                @if($inqu1->status == "New")
                    <a href="/newMarkNew/{{$inqu1->inquiryid}}"  class = "btn btn-success">Mark Active</a>
                 @else
                    <a href="/newMarkActive/{{$inqu1->inquiryid}}"  class = "btn btn-warning">Active</a>
                @endif
            </td>
    ...
    <table class="table table-dark" data-name="mytable" id="myTable4">
     ...
     <th>Change Status</th>
        ...
        <tr>
            ...
            <td>
                @if($inqu1->status == "Expired")
                    <a href="/exprieMarkExpired/{{$inqu1->inquiryid}}"   class = "btn btn-success">Mark Active</a>
                 @else
                    <a href="/expireMarkActive/{{$inqu1->inquiryid}}"   class = "btn btn-warning">Active</a>
                @endif
            </td> 
